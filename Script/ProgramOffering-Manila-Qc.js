...
function selectItem(e) {
    ...
    if (e.target.classList.contains('tab-1')) {
        ...
        content.forEach(item => item.classList.remove('show'))
        Content.classList.add('show');
    } else if (e.target.classList.contains('tab-8')) {
        var Content = document.getElementById("tab-8-content");
        content.forEach(item => item.classList.remove('show'))
        Content.classList.add('show');
    } else if (e.target.classList.contains('tab-9')) {
        var Content = document.getElementById("tab-9-content");
        content.forEach(item => item.classList.remove('show'))
        Content.classList.add('show');
    } else if (e.target.classList.contains('tab-10')) {
        var Content = document.getElementById("tab-10-content");
        content.forEach(item => item.classList.remove('show'))
        Content.classList.add('show');
    } else if (e.target.classList.contains('tab-11')) {
